export default function ServicesSection() {
  const services = [
    ...
    },
    {
      ...
      description: 'Find the perfect rental property or list your property for rent with our comprehensive services.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Make informed investment decisions with our market analysis and investment advisory services.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
